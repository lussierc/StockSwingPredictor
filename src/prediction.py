...
def svr_predict(dates, prices, next_date):
    ...
    svr_lin, svr_poly, svr_rbf, lr, dtr, en, lasso, knr = create_svr_models()  # creates and sets up SVR models
...
def train_svr_models(svr_lin, svr_poly, svr_rbf, lr, dtr, en, lasso, knr, dates, prices):
...
def plot_predictions(dates, prices, svr_rbf, svr_lin, svr_poly, lr, dtr, en, lasso, knr, next_date):
