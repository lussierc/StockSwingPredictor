...
def svr_predict(dates, prices, next_date):
    ...
    svr_lin, svr_poly, svr_rbf, lr = create_svr_models()  # creates and sets up SVR models
    svr_lin, svr_poly, svr_rbf, lr = train_svr_models(
        svr_lin, svr_poly, svr_rbf, lr, dates, prices
    )  # trains SVR models with previous price/date data

    svr_rbf_score = test_svr_models(dates, prices, svr_lin, svr_poly, svr_rbf)

    plot_predictions(dates, prices, svr_rbf, svr_lin, svr_poly, lr, next_date)
...
def create_svr_models():
    ...
    return svr_lin, svr_poly, svr_rbf, lr


def train_svr_models(svr_lin, svr_poly, svr_rbf, lr, dates, prices):
...
def plot_predictions(dates, prices, svr_rbf, svr_lin, svr_poly, lr, next_date):
